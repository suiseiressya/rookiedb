Original link: https://cs186.gitbook.io/project/assignments/proj3/part-2-query-optimization

# Part 2: Query Optimization

![Dataspace](https://cs186.gitbook.io/project/~gitbook/image?url=https%3A%2F%2F678656433-files.gitbook.io%2F%7E%2Ffiles%2Fv0%2Fb%2Fgitbook-legacy-files%2Fo%2Fassets%252F-MFVQnrLlCBowpNWJo1E%252Fsync%252Fb196fa30aebce79b501f167603bba450ca564d5f.png%3Fgeneration%3D1601083825126557%26alt%3Dmedia&width=400&dpr=3&quality=100&sign=ef644cec&sv=2)
...
Before you begin, you should have a good idea of how the `QueryPlan` class is used (see the [Skeleton Code](/project/assignments/proj3/skeleton-code.md) section) and how query operators fit together. For example, to implement a simple query with a single selection predicate:
...
```
GET https://cs186.gitbook.io/project/assignments/proj3/part-2-query-optimization.md?ask=<question>
```
